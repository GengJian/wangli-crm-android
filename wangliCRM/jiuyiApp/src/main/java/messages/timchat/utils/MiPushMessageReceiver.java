...
public class MiPushMessageReceiver extends PushMessageReceiver {
    ...
    //uat
//    private long mBussId =4297;
    //prd
    private long mBussId =4401;
...
//        MiPushClient.clearNotification(context);
        ...
        Log.e(TAG, "regId: " + mRegId + " | topic: " + mTopic + " | alias: " + mAlias
                + " | account: " + mAccount + " | starttime: " + mStartTime + " | endtime: " + mEndTime);
        Intent i = new Intent();
        i.setClassName("com.jiuyi.android", "com.jiuyi.activity.common.activity.JiuyiHeadPageActivity");
...
//                TIMOfflinePushToken param = new TIMOfflinePushToken(mBussId, mRegId);
                TIMOfflinePushToken param = new TIMOfflinePushToken(Constant.MiBussId, mRegId);
