 ...
 */
public class PerformaceUtils {

    private static PerformaceUtils single = null;

    private List<String> searchHistory = new ArrayList<String>();
    ;


    private final String KEY = "performaceLooked_history";

    // 静态工厂方法
    public static PerformaceUtils getInstance() {
        if (single == null) {
            single = new PerformaceUtils();
        }
        return single;
    }
