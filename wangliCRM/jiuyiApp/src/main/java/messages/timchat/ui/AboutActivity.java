...
//        messages.timchat.ui.LineControllerView imsdk = (messages.timchat.ui.LineControllerView) findViewById(R.id.imsdk);
//        imsdk.setContent(TIMManager.getInstance().getVersion());
//        messages.timchat.ui.LineControllerView qalsdk = (messages.timchat.ui.LineControllerView) findViewById(R.id.qalsdk);
//        qalsdk.setContent(QALSDKManager.getInstance().getSdkVersion());
//        messages.timchat.ui.LineControllerView tlssdk = (messages.timchat.ui.LineControllerView) findViewById(R.id.tlssdk);
//        tlssdk.setContent(TLSHelper.getInstance().getSDKVersion());
//        final messages.timchat.ui.LineControllerView env = (messages.timchat.ui.LineControllerView) findViewById(R.id.env);
...
//                new messages.timchat.ui.ListPickerDialog().show(envs, getSupportFragmentManager(), new DialogInterface.OnClickListener() {
//                    @Override
...
//            }
//        });
//        final messages.timchat.ui.LineControllerView log = (messages.timchat.ui.LineControllerView) findViewById(R.id.logLevel);
...
//            @Override
//            public void onClick(View v) {
//                new messages.timchat.ui.ListPickerDialog().show(logNames, getSupportFragmentManager(), new DialogInterface.OnClickListener() {
//                    @Override
//                    public void onClick(DialogInterface dialog, final int which) {
