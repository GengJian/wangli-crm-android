...
import messages.timchat.utils.EmoticonUtil;
...
public class ContactMessage extends Message {
    ...
    public ContactMessage(TIMMessage message){
        this.message = message;
    }

    public ContactMessage(String s, int id){
    ...
    public ContactMessage(TIMMessageDraft draft){
        message = new TIMMessage();
    ...
    public ContactMessage(Editable s){
        message = new TIMMessage();
