...
public class GroupTipMessage extends Message {
    ...
    public String getSummary() {
        ...
        switch (e.getTipsType()){
            case CancelAdmin:
            case SetAdmin:
                return JiuyiMainApplication.getIns().getString(R.string.summary_group_admin_change);
            case Join:
                ...
                return stringBuilder +
                        JiuyiMainApplication.getIns().getString(R.string.summary_group_mem_add);
            case Kick:
                return e.getUserList().get(0) +
                        JiuyiMainApplication.getIns().getString(R.string.summary_group_mem_kick);
            case ModifyMemberInfo:
                ...
                return stringBuilder +
                        JiuyiMainApplication.getIns().getString(R.string.summary_group_mem_modify);
            case Quit:
                return e.getOpUser() +
                        JiuyiMainApplication.getIns().getString(R.string.summary_group_mem_quit);
            case ModifyGroupInfo:
                return JiuyiMainApplication.getIns().getString(R.string.summary_group_info_change);
        }
        return "";
    }
