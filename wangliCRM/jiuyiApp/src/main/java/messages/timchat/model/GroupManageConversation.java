...
import messages.timchat.ui.GroupManageMessageActivity;
...
public class GroupManageConversation extends Conversation {
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return JiuyiMainApplication.getIns().getResources().getString(R.string.summary_me)+
                            JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_invite)+
                            to+
                            JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_invite)+
                                JiuyiMainApplication.getIns().getResources().getString(R.string.summary_me)+
                                JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return JiuyiMainApplication.getIns().getResources().getString(R.string.summary_me)+
                            JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+ JiuyiMainApplication.getIns().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return JiuyiMainApplication.getIns().getString(R.string.conversation_system_group);
    }
