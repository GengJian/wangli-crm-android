...
/**
 * ****************************************************************
 * 文件名称 : JiuyiFourMarketPlanNewActivity
 * 作       者 : zhengss
 * 创建时间:2018/3/26 14:43
 * 文件描述 : 木门4个计划录入界面
 *****************************************************************
 */
public class JiuyiFourMarketPlanNewActivity extends JiuyiActivityBase {
    ...
    private JiuyiItemGroup jig_monthCumulative,jig_signIntent,jig_signactual;
    ...
    private MarketWorkPlanBean.ContentBean createBean;
    ...
    private String backEndFlag="workPlan";
    //申明对象
    ...
    @Override
    public void onInit() {
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_newfourmarketplan_layout"), null);
        ...
        planType=mBundle.getString(JiuyiBundleKey.PARAM_BILLTYPE);
        ...
        if(operatorType.equals(ViewOperatorType.ADD)){
            createBean=new MarketWorkPlanBean.ContentBean();
            createBean.setWorkPlanType(planType);
        }
        initViews();
        if(operatorType.equals(ViewOperatorType.ADD)){
            getInfo();
...
//        });
        ...
        jig_province.setItemOnClickListener(new JiuyiItemGroup.ItemOnClickListener() {
            ...
            public void onItemClick(View v) {
                if(Func.IsStringEmpty(jigSalesman.getText())){
                    Toast.makeText(JiuyiFourMarketPlanNewActivity.this, "请先选择业务员", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        jig_developprovince.setItemOnClickListener(new JiuyiItemGroup.ItemOnClickListener() {
            ...
            public void onItemClick(View v) {
                ...
                AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiFourMarketPlanNewActivity.this);
                buidler.setTitle("省份");
                final String[] data;
...
/*
                    buidler.setSingleChoiceItems(data, -1, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            jig_developprovince.setText(data[which].trim());
                            jig_salesTarget2.setText(planDevelopTargetBeanList.get(which).getSalesTarget()+"");
                            if(operatorType.equals(ViewOperatorType.EDIT) && createBean!=null
                                    && createBean.getProvince()!=null && createBean.getDevelopmentProvince().equals(data[which].trim())){
                                sumAccumulateVisit=createBean.getAccumulateVisit();
                                setShipmentData2();
                            }else{
                                getSumDevelopActualShipment(inputParamMap);
                            }
                            dialog.dismiss();
                        }
                    });
*/
                    ...
                    Toast.makeText(JiuyiFourMarketPlanNewActivity.this, "无匹配结果", Toast.LENGTH_SHORT).show();
                    return;
                }

            }
        });
        jig_monthCumulative = (JiuyiItemGroup) mBodyLayout.findViewById(R.id.jig_monthCumulative);
        jig_signIntent = (JiuyiItemGroup) mBodyLayout.findViewById(R.id.jig_signIntent);
        jig_signactual = (JiuyiItemGroup) mBodyLayout.findViewById(R.id.jig_signactual);
...
//            createBean.setWorkPlanDate(jigWorkPlanDate.getText().trim());
        ...
        rv_clientdetaillist.setLayoutManager(new LinearLayoutManager(JiuyiFourMarketPlanNewActivity.this));
        rv_clientdetaillist.setHasFixedSize(true);
        rv_clientdetaillist.setItemAnimator(new DefaultItemAnimator());
        rv_clientdetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiFourMarketPlanNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rvDetaillist.setLayoutManager(new LinearLayoutManager(JiuyiFourMarketPlanNewActivity.this));
        rvDetaillist.setHasFixedSize(true);
        rvDetaillist.setItemAnimator(new DefaultItemAnimator());
        rvDetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiFourMarketPlanNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rv_unfuldetaillist.setLayoutManager(new LinearLayoutManager(JiuyiFourMarketPlanNewActivity.this));
        ...
        rv_unfuldetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiFourMarketPlanNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rv_intentdetaillist.setLayoutManager(new LinearLayoutManager(JiuyiFourMarketPlanNewActivity.this));
        rv_intentdetaillist.setHasFixedSize(true);
        rv_intentdetaillist.setItemAnimator(new DefaultItemAnimator());
        rv_intentdetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiFourMarketPlanNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rv_signintentdetaillist.setLayoutManager(new LinearLayoutManager(JiuyiFourMarketPlanNewActivity.this));
        rv_signintentdetaillist.setHasFixedSize(true);
        rv_signintentdetaillist.setItemAnimator(new DefaultItemAnimator());
        rv_signintentdetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiFourMarketPlanNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            if (viewType == VIEW_TYPE_MENU_DELETE) { // 是需要添加多个菜单的Item。
                SwipeMenuItem wechatItem = new SwipeMenuItem(JiuyiFourMarketPlanNewActivity.this)
...
//        }
    ...
    private void getInfo() {
        showLoadingDialog();
        String url ;
//        if("GOLDGOOD".equals(planType)){
//            url="jin-mu/getInfo";
//        }else{
//            url=backEndFlag+"/getInfo/"+planType;
//        }
        JiuyiHttp.POST(backEndFlag+"/getInfo/"+planType)
                .tag("request_get_"+backEndFlag)
                .addHeader("Authorization", Rc.id_tokenparam)
                .request(new ACallback<MarketWorkPlanBean.ContentBean>() {
                    @RequiresApi(api = Build.VERSION_CODES.N)
                    @Override
                    public void onSuccess(MarketWorkPlanBean.ContentBean contentBean) {
...
//                            }
                            ...
                            jig_signIntent.setText(contentBean.getSignIntention()+"");
                            jig_signactual.setText(contentBean.getActualSign()+"");

                            jig_monthCumulative.setText(contentBean.getAccumulateVisit()+"");
                            ...
                            if(contentBean.getWorkPlanReportingProjects()!=null && contentBean.getWorkPlanReportingProjects().size()>0){
                                for(int i=0;i<contentBean.getWorkPlanReportingProjects().size();i++){
                                    contentBean.getWorkPlanReportingProjects().get( i ).setId( null );
                                }
                                reportingProjectsBeans =contentBean.getWorkPlanReportingProjects();
                                menuAdapter.setmViewTypeBeanList(reportingProjectsBeans);
                                menuAdapter.notifyDataSetChanged();
                            }
                            if(contentBean.getWorkPlanUnfulfilledProjects()!=null && contentBean.getWorkPlanUnfulfilledProjects().size()>0){
                                for(int i=0;i<contentBean.getWorkPlanUnfulfilledProjects().size();i++){
                                    contentBean.getWorkPlanUnfulfilledProjects().get( i ).setId( null );
                                }
                                unfulfilledProjectsBeans =contentBean.getWorkPlanUnfulfilledProjects();
                                unfulMutiAdapter.setmViewTypeBeanList(unfulfilledProjectsBeans);
                                unfulMutiAdapter.notifyDataSetChanged();
                            }
                            if(contentBean.getWorkPlanVisitIntentions()!=null && contentBean.getWorkPlanVisitIntentions().size()>0){
                                for(int i=0;i<contentBean.getWorkPlanVisitIntentions().size();i++){
                                    contentBean.getWorkPlanVisitIntentions().get( i ).setId( null );
                                }
                                visitIntentionsBeans =contentBean.getWorkPlanVisitIntentions();
                                newVisitIntentMutiAdapter.setmViewTypeBeanList(visitIntentionsBeans);
                                newVisitIntentMutiAdapter.notifyDataSetChanged();
                            }
                            if(contentBean.getWorkPlanSignIntentions()!=null && contentBean.getWorkPlanSignIntentions().size()>0){
                                for(int i=0;i<contentBean.getWorkPlanSignIntentions().size();i++){
                                    contentBean.getWorkPlanSignIntentions().get( i ).setId( null );
                                }
                                signIntentionsBeans =contentBean.getWorkPlanSignIntentions();
                                signIntentMutiAdapter.setmViewTypeBeanList(signIntentionsBeans);
                                signIntentMutiAdapter.notifyDataSetChanged();
                            }

                            if(contentBean.getWorkPlanItems()!=null && contentBean.getWorkPlanItems().size()>0){
                                for(int i=0;i<contentBean.getWorkPlanItems().size();i++){
                                    contentBean.getWorkPlanItems().get( i ).setId( null );
                                }
                                huaJueItemsBeans =contentBean.getWorkPlanItems();
                                marketClientMutiAdapter.setmViewTypeBeanList(huaJueItemsBeans);
                                marketClientMutiAdapter.notifyDataSetChanged();
//                                for(int i=0;i<contentBean.getWorkPlanItems().size();i++){
//                                    getDetailAttachment("WORK_PLAN_ITEM",contentBean.getWorkPlanItems().get(i).getId(),i);
//                                }
                            }else{
                    ...
                    public void onSuccess(MarketWorkPlanBean.ContentBean contentBean) {
                        if(contentBean!=null){
                            ...
                            if(contentBean.getWorkPlanItems()!=null && contentBean.getWorkPlanItems().size()>0){
                                ...
                                for(int i=0;i<contentBean.getWorkPlanItems().size();i++){
                                    getDetailAttachment("WORK_PLAN_ITEM",contentBean.getWorkPlanItems().get(i).getId(),i);
                                    getDetailAttachmentTwo("WORK_PLAN_ITEM_TWO",contentBean.getWorkPlanItems().get(i).getId(),i);
                                }
                            }else{
                                if(progressLoadingDialog!=null){
                                    progressLoadingDialog.dismiss();
    ...
    public void setBean(){
        ...
        if(!Func.IsStringEmpty(jig_monthCumulative.getText().toString().trim())){
            createBean.setAccumulateVisit(Func.convertToLong(jig_monthCumulative.getText().toString().trim()));
        }

        if(!Func.IsStringEmpty(jig_signIntent.getText().toString().trim())){
            createBean.setSignIntention(Func.convertToLong(jig_signIntent.getText().toString().trim()));
        }
        if(!Func.IsStringEmpty(jig_signactual.getText().toString().trim())){
            createBean.setActualSign(Func.convertToLong(jig_signactual.getText().toString().trim()));
        }
...
//        }
        ...
        if(unfulfilledProjectsBeans !=null && unfulfilledProjectsBeans.size()>0){
            createBean.setWorkPlanUnfulfilledProjects(unfulfilledProjectsBeans);
        }else{
            createBean.setWorkPlanUnfulfilledProjects(null);
        }
        if(reportingProjectsBeans !=null && reportingProjectsBeans.size()>0){
            createBean.setWorkPlanReportingProjects(reportingProjectsBeans);
        }else{
            createBean.setWorkPlanReportingProjects(null);
        }
        if(huaJueItemsBeans !=null && huaJueItemsBeans.size()>0){
            createBean.setWorkPlanItems(huaJueItemsBeans);
        }else{
            createBean.setWorkPlanItems(null);
        }
        if(visitIntentionsBeans !=null && visitIntentionsBeans.size()>0){
            createBean.setWorkPlanVisitIntentions(visitIntentionsBeans);
        }else{
            createBean.setWorkPlanVisitIntentions(null);
        }
        if(signIntentionsBeans !=null && signIntentionsBeans.size()>0){
            createBean.setWorkPlanSignIntentions(signIntentionsBeans);
        }else{
            createBean.setWorkPlanSignIntentions(null);
        }
    ...
    public void getSumActualShipment(Map<String, Object> inputParamMap){
        JiuyiHttp.POST(backEndFlag+"/sum-actualShipment/"+planType+"/"+jig_province.getText())
                ...
                .request(new ACallback<SumActualShipmentBean>() {
                    ...
                    public void onSuccess(SumActualShipmentBean result ) {
                        if(result!=null){
                            ...
                            jig_monthCumulative.setText(sumAccumulateVisit+"");
                            setShipmentData2();
                        }
                    }
    ...
    public void setSignData(){
        if(signIntentMutiAdapter!=null && signIntentMutiAdapter.mViewTypeBeanList.size()>0){
            int count=0;
            ...
            jig_signIntent.setText(signIntentionsBeans.size()+"");
            jig_signactual.setText(count+"");
        }else{
            jig_signIntent.setText("0");
            jig_signactual.setText("0");
        }
        ...
        JiuyiHttp.GET("attachment/list/"+fktype+"/"+id)
                ...
                .request(new ACallback<List<AttachmentBean>>() {
                    ...
                    public void onSuccess(List<AttachmentBean> data) {
                        if(data!=null){
                            createBean.getWorkPlanItems().get(i).setAttachments(data);
                            if(i==createBean.getWorkPlanItems().size()-1){
                                if(progressLoadingDialog!=null){
                                    progressLoadingDialog.dismiss();
                                }
                            }
    ...
    private void getDetailAttachmentTwo(String fktype,Long id,int i) {
        JiuyiHttp.GET("attachment/list/"+fktype+"/"+id)
                ...
                .request(new ACallback<List<AttachmentBean>>() {
                    ...
                    public void onSuccess(List<AttachmentBean> data) {
                        if(data!=null){
                            createBean.getWorkPlanItems().get(i).setAttachmentsTwo(data);
                            if(i==createBean.getWorkPlanItems().size()-1){
                                if(progressLoadingDialog!=null){
                                    progressLoadingDialog.dismiss();
                                }
...
public void getPlanTarget(Map<String, Object> inputParamMap){
        if("TIMBER".equals(planType)){
            JiuyiHttp.POST("work-plan-target-area/findByBrandAndProvince/0")
                    ...
                    .request(new ACallback<List<PlanTargetProvinceBrandBean>>() {
                        ...
                        public void onSuccess(List<PlanTargetProvinceBrandBean> result ) {
                            ...
                            JiuyiHttp.POST("work-plan-target-area/findByBrandAndProvince/1")
                                    .setJson(GsonUtil.gson().toJson(inputParamMap))
                                    .addHeader("Authorization",Rc.id_tokenparam)
                                    .request(new ACallback<List<PlanTargetProvinceBrandBean>>() {
                                        @Override
                                        public void onSuccess(List<PlanTargetProvinceBrandBean> result ) {
                                            if(result!=null){
                                                if(planTargetBeanList==null||planTargetBeanList.size()<=0){
                                                    ...
                                                    for(PlanTargetProvinceBrandBean planTargetBean:result){
                                                        planTargetBeanList.add(planTargetBean);
                                                    }
                                                }
            ...
            JiuyiHttp.POST("work-plan-target-area/findByBrandAndProvince/3")
                    .setJson(GsonUtil.gson().toJson(inputParamMap))
                    .addHeader("Authorization",Rc.id_tokenparam)
                    .request(new ACallback<List<PlanTargetProvinceBrandBean>>() {
                        @Override
                                            ...
                                            if(result!=null){
                                                ...
                                                if(planTargetBeanList!=null &&planTargetBeanList.size()>0){
                                                    ...
                                                    for(int i=0;i<planTargetBeanList.size();i++){
                                                        ...
                                                        if(planTargetProvinceBrandBean.getProvince()!=null && planTargetProvinceBrandBean.getBrand()!=null && planTargetProvinceBrandBean.getType()!=null){
                                                            data[i]=planTargetBeanList.get(i).getProvince()+"-"+planTargetBeanList.get(i).getBrand().getBrandName()+"-"+planTargetBeanList.get(i).getType();
                                                        }
                                                        b[i]=false;
                                                    }
                                                    buidler.setMultiChoiceItems(data, b, new DialogInterface.OnMultiChoiceClickListener() {
...
//                                                getSumActualShipment(inputParamMap);
    ...
    public void getSapSalesByBrandAdnYear(ProvinceAndBrand provinceAndBrand){
        String url="";
        if("CERART".equals(planType)){
            url="workPlan/getSapSalesByBrandAdnYear";
        }else{
            url="workPlan/getSapSalesByBrandAdnYear";
        }
        JiuyiHttp.POST(url)
