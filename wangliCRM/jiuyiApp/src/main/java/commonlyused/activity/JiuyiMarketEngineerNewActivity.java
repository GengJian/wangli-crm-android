 ...
 *****************************************************************
 */
public class JiuyiMarketEngineerNewActivity extends JiuyiActivityBase {
    ...
    private NewProjectMutiAdapter menuAdapter;
    private NewUnfulProjectMutiAdapter unfulMutiAdapter;
    private NewMarketClientMutiAdapter marketClientMutiAdapter;
    private RelativeLayout rvNew,rv_signnew,rv_clientnew;
    private String operType="";
    private static final int VISIT_CODE = 100;
    private MarketEngineeringBean.ReportingProjectsBean reportingProjectsBean;
    private List<MarketEngineeringBean.ReportingProjectsBean> reportingProjectsBeans;

    private MarketEngineeringBean.UnfulfilledProjectsBean unfulfilledProjectsBean;
    private List<MarketEngineeringBean.UnfulfilledProjectsBean> unfulfilledProjectsBeans;

    private MarketEngineeringBean.MarketEngineeringItemsBean marketEngineeringItemsBean;
    private List<MarketEngineeringBean.MarketEngineeringItemsBean> marketEngineeringItemsBeans;

    private int currentPosition=-1, currentUnfulfillPosition =-1,currentclientPosition =-1;
    private MarketEngineeringBean.ContentBean createBean;
    ...
    private String backEndFlag="market-engineering";
    //申明对象
    ...
    @Override
    public void onInit() {
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_newmarketengineer_layout"), null);
        ...
        if(operatorType.equals(ViewOperatorType.ADD)){
            createBean=new MarketEngineeringBean.ContentBean();
        }
        initViews();
        if(operatorType.equals(ViewOperatorType.ADD)){
            getInfo();
        ...
        jig_province.setItemOnClickListener(new JiuyiItemGroup.ItemOnClickListener() {
            ...
            public void onItemClick(View v) {
                if(Func.IsStringEmpty(jigSalesman.getText())){
                    Toast.makeText(JiuyiMarketEngineerNewActivity.this, "请先选择业务员", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//            createBean.setWorkPlanDate(jigWorkPlanDate.getText().trim());
        ...
        rv_clientdetaillist.setLayoutManager(new LinearLayoutManager(JiuyiMarketEngineerNewActivity.this));
        rv_clientdetaillist.setHasFixedSize(true);
        rv_clientdetaillist.setItemAnimator(new DefaultItemAnimator());
        rv_clientdetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiMarketEngineerNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rv_clientnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), JiuyiNewMarketClientDtailMutiActivity.class);
        ...
        rvDetaillist.setLayoutManager(new LinearLayoutManager(JiuyiMarketEngineerNewActivity.this));
        rvDetaillist.setHasFixedSize(true);
        rvDetaillist.setItemAnimator(new DefaultItemAnimator());
        rvDetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiMarketEngineerNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rvNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), JiuyiNewProjectDtailMutiActivity.class);
                intent.putExtra(JiuyiBundleKey.PARAM_OPERATORTYPE, ViewOperatorType.ADD);
                intent.putExtra(JiuyiBundleKey.PARAM_BILLOPERATORTYPE, operatorType);
        ...
        rv_unfuldetaillist.setLayoutManager(new LinearLayoutManager(JiuyiMarketEngineerNewActivity.this));
        rv_unfuldetaillist.setHasFixedSize(true);
        rv_unfuldetaillist.setItemAnimator(new DefaultItemAnimator());
        rv_unfuldetaillist.addItemDecoration(new jiuyiRecycleViewDivider(JiuyiMarketEngineerNewActivity.this, LinearLayoutManager.VERTICAL, 1, getResources().getColor(R.color.background)));
        ...
        rv_signnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), JiuyiNewUnfullProjectDtailMutiActivity.class);
                intent.putExtra(JiuyiBundleKey.PARAM_OPERATORTYPE, ViewOperatorType.ADD);
                intent.putExtra(JiuyiBundleKey.PARAM_BILLOPERATORTYPE, operatorType);
        ...
        menuAdapter = new NewProjectMutiAdapter(reportingProjectsBeans);
        ...
        unfulMutiAdapter = new NewUnfulProjectMutiAdapter(unfulfilledProjectsBeans);
        ...
        marketEngineeringItemsBeans =new ArrayList<>();
        marketClientMutiAdapter = new NewMarketClientMutiAdapter(marketEngineeringItemsBeans);
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            if (viewType == VIEW_TYPE_MENU_DELETE) { // 是需要添加多个菜单的Item。
                SwipeMenuItem wechatItem = new SwipeMenuItem(JiuyiMarketEngineerNewActivity.this)
    ...
    private OnSwipeMenuItemClickListener menuItemClickListener = new OnSwipeMenuItemClickListener() {
        ...
        public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, int direction) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                if(menuAdapter!=null){
                    MarketEngineeringBean.ReportingProjectsBean contentBean=menuAdapter.mViewTypeBeanList.get(adapterPosition);
                    if(contentBean!=null){
...
//                        setShipmentData();
    ...
    private OnItemClickListener onItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(int position) {
            if(menuAdapter!=null){
                MarketEngineeringBean.ReportingProjectsBean contentBean=menuAdapter.mViewTypeBeanList.get(position);
                if(contentBean!=null){
    ...
    private OnItemClickListener onItemClickListener2 = new OnItemClickListener() {
        ...
        public void onItemClick(int position) {
            if(unfulMutiAdapter !=null){
                MarketEngineeringBean.UnfulfilledProjectsBean contentBean= unfulMutiAdapter.mViewTypeBeanList.get(position);
                if(contentBean!=null){
    ...
    private OnSwipeMenuItemClickListener menuItemClickListener2 = new OnSwipeMenuItemClickListener() {
        ...
        public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, int direction) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                if(unfulMutiAdapter !=null){
                    MarketEngineeringBean.UnfulfilledProjectsBean contentBean= unfulMutiAdapter.mViewTypeBeanList.get(adapterPosition);
                    if(contentBean!=null){
                        ...
                        jigExpectVisit.setText(reportingProjectsBeans.size()+"");
    ...
    private OnItemClickListener onItemClickListener3 = new OnItemClickListener() {
        ...
        public void onItemClick(int position) {
            if(marketClientMutiAdapter !=null){
                MarketEngineeringBean.MarketEngineeringItemsBean contentBean= marketClientMutiAdapter.mViewTypeBeanList.get(position);
                if(contentBean!=null){
    ...
    private OnSwipeMenuItemClickListener menuItemClickListener3 = new OnSwipeMenuItemClickListener() {
        ...
        public void onItemClick(Closeable closeable, int adapterPosition, int menuPosition, int direction) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                if(marketClientMutiAdapter !=null){
                    MarketEngineeringBean.MarketEngineeringItemsBean contentBean= marketClientMutiAdapter.mViewTypeBeanList.get(adapterPosition);
                    if(contentBean!=null){
                        ...
                        jigExpectVisit.setText(marketEngineeringItemsBeans.size()+"");
                        jigActualVisit.setText(count+"");
                    }
                }
            }
...
//                        jigActualVisit.setText(count+"");
            ...
            case 400:
                bundle = data.getExtras();
                marketEngineeringItemsBean = bundle.getParcelable(JiuyiBundleKey.PARAM_COMMONBEAN2);
                if (marketEngineeringItemsBean != null) {
                    if (marketEngineeringItemsBeans == null) {
                        marketEngineeringItemsBeans = new ArrayList<>();
                    }
                    if(!marketEngineeringItemsBeans.contains( marketEngineeringItemsBeans )){
                        marketEngineeringItemsBeans.add(marketEngineeringItemsBean);
                    }
                    if (marketClientMutiAdapter == null) {
                        marketClientMutiAdapter = new NewMarketClientMutiAdapter(marketEngineeringItemsBeans);
                        marketClientMutiAdapter.setOnItemClickListener(onItemClickListener3);
                        ...
                        marketClientMutiAdapter.setmViewTypeBeanList(marketEngineeringItemsBeans);
                        marketClientMutiAdapter.notifyDataSetChanged();
                    }
                    int count=0;
                    for(int i=0;i<marketClientMutiAdapter.mViewTypeBeanList.size();i++){
            ...
            case 401:
                ...
                marketEngineeringItemsBean = bundle.getParcelable(JiuyiBundleKey.PARAM_COMMONBEAN2);
                if (marketEngineeringItemsBean != null) {
                    if (marketEngineeringItemsBeans != null && marketEngineeringItemsBeans.size() > 0 && currentclientPosition >= 0) {
                        marketEngineeringItemsBeans.set(currentclientPosition, marketEngineeringItemsBean);
                        marketClientMutiAdapter.setmViewTypeBeanList(marketEngineeringItemsBeans);
                        marketClientMutiAdapter.notifyDataSetChanged();
                        int count=0;
                        for(int i=0;i<marketClientMutiAdapter.mViewTypeBeanList.size();i++){
    ...
    public boolean check(){
        ...
        if(marketClientMutiAdapter!=null && marketClientMutiAdapter.mViewTypeBeanList.size()<1){
...
//        }
    ...
    private void getInfo() {
        ...
        JiuyiHttp.POST(backEndFlag+"/getInfo")
                ...
                .request(new ACallback<MarketEngineeringBean.ContentBean>() {
                    @RequiresApi(api = Build.VERSION_CODES.N)
                    @Override
                    public void onSuccess(MarketEngineeringBean.ContentBean contentBean) {
...
//                            }
                            ...
                            if(contentBean.getReportingProjects()!=null && contentBean.getReportingProjects().size()>0){
                                for(int i=0;i<contentBean.getReportingProjects().size();i++){
                                    contentBean.getReportingProjects().get( i ).setId( null );
                                }
                                reportingProjectsBeans =contentBean.getReportingProjects();
                                menuAdapter.setmViewTypeBeanList(reportingProjectsBeans);
                                menuAdapter.notifyDataSetChanged();
                            }
                            if(contentBean.getUnfulfilledProjects()!=null && contentBean.getUnfulfilledProjects().size()>0){
                                for(int i=0;i<contentBean.getUnfulfilledProjects().size();i++){
                                    contentBean.getUnfulfilledProjects().get( i ).setId( null );
                                }
                                unfulfilledProjectsBeans =contentBean.getUnfulfilledProjects();
                                unfulMutiAdapter.setmViewTypeBeanList(unfulfilledProjectsBeans);
                                unfulMutiAdapter.notifyDataSetChanged();
                            }
                            if(contentBean.getMarketEngineeringItems()!=null && contentBean.getMarketEngineeringItems().size()>0){
                                for(int i=0;i<contentBean.getMarketEngineeringItems().size();i++){
                                    contentBean.getMarketEngineeringItems().get( i ).setId( null );
                                }
                                marketEngineeringItemsBeans =contentBean.getMarketEngineeringItems();
                                marketClientMutiAdapter.setmViewTypeBeanList(marketEngineeringItemsBeans);
                                marketClientMutiAdapter.notifyDataSetChanged();
                            }
    ...
    public void setBean(){
        ...
        if(!Func.IsStringEmpty(jigExpectVisit.getText().toString().trim())){
            createBean.setExpectVisit(Double.parseDouble(jigExpectVisit.getText().toString().trim()));
        }
        if(!Func.IsStringEmpty(jigActualVisit.getText().toString().trim())){
            createBean.setActualVisit(Double.parseDouble(jigActualVisit.getText().toString().trim()));
        }
        ...
        if(unfulfilledProjectsBeans !=null && unfulfilledProjectsBeans.size()>0){
            createBean.setUnfulfilledProjects(unfulfilledProjectsBeans);
        }else{
            createBean.setUnfulfilledProjects(null);
        }
        if(reportingProjectsBeans !=null && reportingProjectsBeans.size()>0){
            createBean.setReportingProjects(reportingProjectsBeans);
        }else{
            createBean.setReportingProjects(null);
        }
        if(marketEngineeringItemsBeans !=null && marketEngineeringItemsBeans.size()>0){
            createBean.setMarketEngineeringItems(marketEngineeringItemsBeans);
        }else{
            createBean.setMarketEngineeringItems(null);
        }
...
//        JiuyiHttp.POST(backEndFlag+"/sum-actualShipment")
...
//    }
    public void setShipmentData(){
        if(menuAdapter!=null && menuAdapter.mViewTypeBeanList.size()>0){
            ...
            jigExpectVisit.setText("0");
            jigActualVisit.setText("0");
        }
        ...
        JiuyiHttp.POST("work-plan-target-area/findByBrandAndProvince/1")
                ...
                .request(new ACallback<List<PlanTargetProvinceBrandBean>>() {
                    ...
                    public void onSuccess(List<PlanTargetProvinceBrandBean> result ) {
                        if(result!=null){
                            planTargetBeanList=result;
                            AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiMarketEngineerNewActivity.this);
                            buidler.setTitle("省份");
                            final String[] data;
                            if(progressLoadingDialog!=null){
                                progressLoadingDialog.dismiss();
...
//                                            getSumActualShipment(inputParamMap);
                                ...
                                Toast.makeText(JiuyiMarketEngineerNewActivity.this, "无匹配结果", Toast.LENGTH_SHORT).show();
                                return;
                            }
                        }
                    ...
                    public void onSuccess(List<MemberBeanID> result ) {
                        ...
                        if(result!=null  && result.size()>0){
                            for(int i=0;i<result.size();i++){
                                MarketEngineeringBean.MarketEngineeringItemsBean marketEngineeringItemsBean =new MarketEngineeringBean.MarketEngineeringItemsBean();
                                marketEngineeringItemsBean.setMember(result.get(i));
                                if(!marketEngineeringItemsBeans.contains( marketEngineeringItemsBean )){
                                    marketEngineeringItemsBeans.add(marketEngineeringItemsBean);
                                }
                            }
                            if (marketClientMutiAdapter == null) {
        ...
        JiuyiHttp.POST("market-engineering/require-engineer")
                ...
                .request(new ACallback<List<ProvinceProjectBean>>() {
                    ...
                    public void onSuccess(List<ProvinceProjectBean> result ) {
                        ...
                        if(result!=null  && result.size()>0){
                            for(int i=0;i<result.size();i++){
                                MarketEngineeringBean.UnfulfilledProjectsBean contentBean=new MarketEngineeringBean.UnfulfilledProjectsBean();
    ...
    public void getSapSalesByBrandAdnYear(ProvinceAndBrand provinceAndBrand){
        JiuyiHttp.POST("SapDataController/getSapSalesByBrandAdnYear/_GC/LFIMG_")
