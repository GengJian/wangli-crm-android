 ...
 *****************************************************************
 */
public class JiuyiNewUnfullProjectHuaJueDtailMutiActivity extends JiuyiActivityBase {
    ...
    private MarketHuaJueBean.HjUnfulfilledProjectsBean retailChannelItemsBean;
    ...
    public void onInit() {
        ...
        if(operType.equals(ViewOperatorType.ADD)){
            retailChannelItemsBean =new MarketHuaJueBean.HjUnfulfilledProjectsBean();
        }else{
...
//        jig_date.setText(JiuyiDateUtil.getNowTime3());
    ...
    public void setBackActivityBundle() {
        ...
        JiuyiNewUnfullProjectHuaJueDtailMutiActivity.this.setResult(1, intent);
    }
