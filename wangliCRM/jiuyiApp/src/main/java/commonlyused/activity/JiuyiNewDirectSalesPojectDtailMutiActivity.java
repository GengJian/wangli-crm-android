 ...
 *****************************************************************
 */
public class JiuyiNewDirectSalesPojectDtailMutiActivity extends JiuyiActivityBase {
    ...
    private DirectSalesBean.DirectSalesEngineeringItemsBean retailChannelItemsBean;
    ...
    public void onInit() {
        ...
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_newdirectsalesprojectmulti_layout"), null);
        ...
        if(operType.equals(ViewOperatorType.ADD)){
            retailChannelItemsBean =new DirectSalesBean.DirectSalesEngineeringItemsBean();
        }else{
        ...
        if(retailChannelItemsBean !=null) {
            if (retailChannelItemsBean.getProject() != null ) {
                jigClient.setText(retailChannelItemsBean.getProject());
            }
        ...
        if(mbtnsave!=null){
            mbtnsave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    retailChannelItemsBean.setProject(jigClient.getText());
...
//        }
    ...
    public void setBackActivityBundle() {
        ...
        JiuyiNewDirectSalesPojectDtailMutiActivity.this.setResult(1, intent);
    }

    public boolean check(){
        if(TextUtils.isEmpty(jigClient.getText().toString().trim())){
            startDialog(DialogID.DialogDoNothing, "", "请输入项目！", JiuyiDialogBase.Dialog_Type_Yes, null);
            return false;
        }
