 ...
 *****************************************************************
 */
public class JiuyiNewProjectHuaJueDtailMutiActivity extends JiuyiActivityBase {
    ...
    private MarketHuaJueBean.HjReportingProjectsBean retailChannelItemsBean;
    ...
    public void onInit() {
        ...
        if(operType.equals(ViewOperatorType.ADD)){
            retailChannelItemsBean =new MarketHuaJueBean.HjReportingProjectsBean();
        }else{
    ...
    public void setBackActivityBundle() {
        ...
        JiuyiNewProjectHuaJueDtailMutiActivity.this.setResult(1, intent);
    }
