...
/**
 * ****************************************************************
 * 文件名称 : JiuyiNormalImportantContactActivity
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 常用重要联系人
 *****************************************************************
 */
public class JiuyiNormalImportantContactActivity extends JiuyiActivityBase {
    ...
    public void onInit() {
        ...
        manager = new LinearLayoutManager(JiuyiNormalImportantContactActivity.this);
    ...
    public  void  getContactList(final int page){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                JiuyiHttp.POST("contact/find_page_by_operator/true")
...
//                                                }
                                                if(contentBean.getOffice()!=null){
                                                    sortModel.setDept(contentBean.getOffice().toString());
                                                }
                                                ...
                                                if(contentBean.getSimpleSpell()!=null){
                                        ...
                                        if(page==0){
                                            adapter = new NormalDeptLinkmanSortAdapter(JiuyiNormalImportantContactActivity.this, SourceDateList,false);
