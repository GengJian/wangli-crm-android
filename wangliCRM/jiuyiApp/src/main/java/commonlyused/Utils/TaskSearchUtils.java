 ...
 */
public class TaskSearchUtils {

    private static TaskSearchUtils single = null;
    ...
    private final String KEY = "task_search_history";

    // 静态工厂方法
    public static TaskSearchUtils getInstance() {
        if (single == null) {
            single = new TaskSearchUtils();
        }
        return single;
    }
