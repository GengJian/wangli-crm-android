...
public class ContactSearchUtils {
    ...
    private static ContactSearchUtils single = null;
    ...
    private final String KEY = "contact_search_history";

    // 静态工厂方法
    public static ContactSearchUtils getInstance() {
        if (single == null) {
            single = new ContactSearchUtils();
        }
        return single;
    }
