 ...
 *
 */
public class NewProjectHuaJueMutiAdapter extends SwipeMenuAdapter<NewProjectHuaJueMutiAdapter.DefaultViewHolder> {
    ...
    public List<MarketHuaJueBean.HjReportingProjectsBean> getmViewTypeBeanList() {
        return mViewTypeBeanList;
    }

    public void setmViewTypeBeanList(List<MarketHuaJueBean.HjReportingProjectsBean> mViewTypeBeanList) {
        this.mViewTypeBeanList = mViewTypeBeanList;
    }

    public List<MarketHuaJueBean.HjReportingProjectsBean> mViewTypeBeanList;

    private OnItemClickListener mOnItemClickListener;

    public NewProjectHuaJueMutiAdapter(List<MarketHuaJueBean.HjReportingProjectsBean> viewTypeBeanList) {
    ...
    @Override
    public NewProjectHuaJueMutiAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
        return new DefaultViewHolder(realContentView);
    }

    @Override
    public void onBindViewHolder(NewProjectHuaJueMutiAdapter.DefaultViewHolder holder, int position) {
    ...
    static class DefaultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(MarketHuaJueBean.HjReportingProjectsBean viewTypeBean) {
    ...
    //下面两个方法提供给页面刷新和加载时调用
    public void add(List<MarketHuaJueBean.HjReportingProjectsBean> addCustomerList) {
        //增加数据
    ...
    public void refresh(List<MarketHuaJueBean.HjReportingProjectsBean> newList) {
        //刷新数据
