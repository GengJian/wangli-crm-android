 ...
 * ****************************************************************
 */
public class MarketJinMumenBean {
    ...
    public static class ContentBean {
        ...
        public List<MarketHuaJueBean.HjReportingProjectsBean> getJmReportingProjects() {
            return jmReportingProjects;
        }

        public void setJmReportingProjects(List<MarketHuaJueBean.HjReportingProjectsBean> jmReportingProjects) {
            this.jmReportingProjects = jmReportingProjects;
        }

        public List<MarketHuaJueBean.HuaJueItemsBean> getJinMuMenItems() {
            return jinMuMenItems;
        }

        public void setJinMuMenItems(List<MarketHuaJueBean.HuaJueItemsBean> jinMuMenItems) {
            this.jinMuMenItems = jinMuMenItems;
        }

        public List<MarketHuaJueBean.HjUnfulfilledProjectsBean> getJmUnfulfilledProjects() {
            return jmUnfulfilledProjects;
        }

        public void setJmUnfulfilledProjects(List<MarketHuaJueBean.HjUnfulfilledProjectsBean> jmUnfulfilledProjects) {
            this.jmUnfulfilledProjects = jmUnfulfilledProjects;
        }
        ...
        private List<MarketHuaJueBean.HjReportingProjectsBean> jmReportingProjects;
        private List<MarketHuaJueBean.HuaJueItemsBean> jinMuMenItems;
        private List<MarketHuaJueBean.HjUnfulfilledProjectsBean> jmUnfulfilledProjects;
