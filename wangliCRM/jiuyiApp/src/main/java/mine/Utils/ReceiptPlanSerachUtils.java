 ...
 */
public class ReceiptPlanSerachUtils {

    private static ReceiptPlanSerachUtils single = null;
    ...
    private final String KEY = "receiptplansearch_history";

    // 静态工厂方法
    public static ReceiptPlanSerachUtils getInstance() {
        if (single == null) {
            single = new ReceiptPlanSerachUtils();
        }
        return single;
    }
