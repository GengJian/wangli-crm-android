...
/**
 * ****************************************************************
 * 文件名称 : JiuyiMineCollectionOrderFragment
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 我的订单收藏
 *****************************************************************
 */
public class JiuyiMineCollectionOrderFragment extends JiuyiFragmentBase {
     ...
     * 然后返回新的fragment到调用者
     */
    public static JiuyiMineCollectionOrderFragment newInstance(int nPageType) {
        JiuyiMineCollectionOrderFragment f = new JiuyiMineCollectionOrderFragment();
     ...
     * 然后返回新的fragment到调用者
     */
    public static JiuyiMineCollectionOrderFragment newInstance(int nPageType, Bundle mBundle) {
        JiuyiMineCollectionOrderFragment f = new JiuyiMineCollectionOrderFragment();
        Bundle args;
        if(mBundle != null){
...
//        getInfoList(0);
    ...
    public  void  getOrderList(final int page){
        ...
        Thread thread = new Thread()
        {
            ...
            public void run() {
                super.run();
                JiuyiHttp.POST("favorite/ORDER/page?")
