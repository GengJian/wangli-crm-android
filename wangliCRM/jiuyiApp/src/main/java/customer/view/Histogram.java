...
import customer.listener.ChartData;
...
public class Histogram extends Chart {
    ...
    private void initStyle(Context context,AttributeSet attrs) {
        TypedArray types = context.obtainStyledAttributes(attrs, com.zqx.chart.R.styleable.zqxchart_histogram);
        coordinates_color = types.getColor(com.zqx.chart.R.styleable.zqxchart_histogram_hCoordinatesColor,Color.RED);
        rect_text_color = types.getColor(com.zqx.chart.R.styleable.zqxchart_histogram_rectTextColor,Color.BLACK);
        rect_text_size = types.getInteger(com.zqx.chart.R.styleable.zqxchart_histogram_rectTextSize,24);
        x_text_color = types.getColor(com.zqx.chart.R.styleable.zqxchart_histogram_hxTextColor,Color.BLACK);
        y_text_color = types.getColor(com.zqx.chart.R.styleable.zqxchart_histogram_hyTextColor,Color.BLACK);
        x_text_size = types.getInteger(com.zqx.chart.R.styleable.zqxchart_histogram_hxTextSize,30);
        y_text_size = types.getInteger(com.zqx.chart.R.styleable.zqxchart_histogram_hyTextSize,26);
        xpCount = types.getInteger(com.zqx.chart.R.styleable.zqxchart_histogram_hxPointCount,2);
        ypCount = types.getInteger(com.zqx.chart.R.styleable.zqxchart_histogram_hyPointCount,3);
        ...
        for (int i=0; i<xpCount; i++){
            try {
                histogramPaint.setColor(rect_color == null
                        ? getResources().getColor(R.color.jiuyi_cost_color)
                        : rect_color[i]);
            }catch (ArrayIndexOutOfBoundsException e){
                histogramPaint.setColor(getResources().getColor(R.color.jiuyi_cost_color));
            }
