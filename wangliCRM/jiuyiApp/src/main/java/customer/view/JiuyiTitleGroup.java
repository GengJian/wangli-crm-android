...
public class JiuyiTitleGroup extends FrameLayout implements View.OnClickListener {
    ...
    public JiuyiTitleGroup(@NonNull Context context) {
        super(context);
        initView(context);
    }

    public JiuyiTitleGroup(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        initAttrs(context, attrs);
    }

    public JiuyiTitleGroup(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.jiuyi_title_group_layout, null);
