...
public class EfficientClock extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mRingPaint.setColor(Color.parseColor("#5baaf9"));
        canvas.drawArc(mRect,120,120,true,mRingPaint);
        mRingPaint.setColor(Color.parseColor("#f8d05a"));
        canvas.drawArc(mRect,240,60,true,mRingPaint);
        mRingPaint.setColor(Color.parseColor("#ed7674"));
        canvas.drawArc(mRect,300,60,true,mRingPaint);
        mRingPaint.setColor(Color.parseColor("#f64f59"));
...
//                canvas.drawText(String.valueOf(i*2),0,String.valueOf(i*2).length(),0,(fontMetrics.bottom-fontMetrics.top)/2-fontMetrics.bottom,mTextPaint);
        ...
        if (currentValue<=40){
            mDownTextPaint.setColor(Color.parseColor("#5baaf9"));
        }else if (currentValue<=60){
            mDownTextPaint.setColor(Color.parseColor("#f8d05a"));
        }else if (currentValue<=80){
            mDownTextPaint.setColor(Color.parseColor("#ed7674"));
        }else {
            mDownTextPaint.setColor(Color.parseColor("#f64f59"));
        }
