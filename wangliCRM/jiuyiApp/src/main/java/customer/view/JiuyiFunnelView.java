...
/**
 * Created by zhengss on 18/12/20.
 */
public class JiuyiFunnelView extends View implements ValueAnimator.AnimatorUpdateListener{
    ...
    public JiuyiFunnelView(Context context) {
        this(context, null);
    }

    public JiuyiFunnelView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JiuyiFunnelView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mPaintLine.setColor(Color.parseColor("#A8ADB2"));
    ...
    private void drawText1(Canvas canvas) {
        ...
        canvas.drawText("线索", maxWidth + textStartOffsetX, mLastY - mPath1Height / 2 + offY, mPaintText);
    }
    ...
    private void drawText2(Canvas canvas) {
        ...
        canvas.drawText("商机", maxWidth + textStartOffsetX, mLastY - mPath2Height / 2 + offY, mPaintText);
    }
    ...
    private void drawText3(Canvas canvas) {
        ...
        canvas.drawText("报价", maxWidth + textStartOffsetX, mLastY - mPath3Height / 2 + offY, mPaintText);
    }
    ...
    private void drawText4(Canvas canvas) {
        ...
        canvas.drawText("合同", maxWidth + textStartOffsetX, mLastY - mPath4Height / 2 + offY, mPaintText);
    }
    ...
    private void drawText5(Canvas canvas) {
        ...
        canvas.drawText("合同", maxWidth + textStartOffsetX, mLastY - mPath5Height / 2 + offY, mPaintText);
    }
