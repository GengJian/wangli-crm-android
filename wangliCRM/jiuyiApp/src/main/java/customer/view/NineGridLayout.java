...
public abstract class NineGridLayout extends ViewGroup {
    ...
    protected float mSpacing = DEFUALT_SPACING;
    ...
    private List<UserViewInfo> mUrlList = new ArrayList<>();
    ...
    public void setUrlList(List<UserViewInfo> urlList) {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            UserViewInfo url = mUrlList.get(0);
            RatioImageView imageView = createImageView(0, url.getUrl());
        ...
        for (int i = 0; i < size; i++) {
            UserViewInfo url = mUrlList.get(i);
            RatioImageView imageView;
            if (!mIsShowAll) {
                if (i < MAX_COUNT - 1) {
                    imageView = createImageView(i, url.getUrl());
...
//        params.width = width;
    ...
    private int getListSize(List<UserViewInfo> list) {
    ...
    protected int getFontHeight(float fontSize) {
    ...
    protected abstract void onClickImage(int position, String url, List<UserViewInfo> urlList);
}
