...
import customer.adapter.FolderAdapter;
import customer.adapter.MediaGridAdapter;
import customer.adapter.SpacingDecoration;
import customer.entity.Folder;
import customer.entity.Media;
import customer.listener.DataCallback;
import customer.listener.ImageLoader;
import customer.listener.MediaLoader;
import customer.listener.PickerConfig;
import customer.listener.VideoLoader;
...
//        Bimp.setTempVideoSelectBitmap(selects);
