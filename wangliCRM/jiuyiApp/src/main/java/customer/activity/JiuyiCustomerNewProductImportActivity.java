...
/**
 * ****************************************************************
 * 文件名称 : JiuyiCustomerNewProductImportActivity
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 进出口新增页面
 *****************************************************************
 */
public class JiuyiCustomerNewProductImportActivity extends JiuyiNewIncludeAttachActivity {
    ...
    private ProductimportBean.ContentBean updateBean;
    private ProductimportBean.ContentBean productinfoBean;
    ...
    public void onInit() {
        ...
        super.onInit();
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_customernewproductimport_layout"), null);
                                            ...
                                            if(attachmentsBeanslist.size()==Bimp.tempSelectBitmap.size()){
                                                if(viewOperatorType.equals(ViewOperatorType.EDIT)){
                                                    ...
                                                    if(productinfoBean==null){
                                                        productinfoBean=new ProductimportBean.ContentBean();
                                                    }
    ...
    public void initViews(){
        ...
        tvType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiCustomerNewProductImportActivity.this);
                buidler.setTitle("信息类型");
                final String[] data;
        ...
        if (tvDate != null) {
            tvDate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DatePickDialog dialog = new DatePickDialog(JiuyiCustomerNewProductImportActivity.this);
                    //设置上下年分限制
    ...
    public void submit(){
        JiuyiHttp.POST("in_ex_port_info/create")
   ...
   private void getProductinfoList(long id) {
    JiuyiHttp.GET("in_ex_port_info/detail/"+id)
            .tag("request_get_in_ex_port_info")
            .addHeader("Authorization", Rc.id_tokenparam)
            .request(new ACallback<ProductimportBean.ContentBean>() {
                @Override
                public void onSuccess(ProductimportBean.ContentBean contentBean) {
                    if(contentBean!=null){
                        ...
                        if(contentBean.getInfoDate()!=null){
                            tvDate.setText(contentBean.getInfoDate().toString());
                        }
    ...
    public void updateProductInfo(){
        if(updateBean==null){
            updateBean =new ProductimportBean.ContentBean();;
        ...
        JiuyiHttp.PUT("in_ex_port_info/update")
