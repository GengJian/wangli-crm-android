...
/**
 * ****************************************************************
 * 文件名称 : JiuyiAddProductActivity
 * 作       者 : zhengss
 * 创建时间:2018/8/9 14:43
 * 文件描述 : 特价产品
 *****************************************************************
 */
public class JiuyiAddProductActivity extends JiuyiActivityBase {
    private TextView tv_patchnumber,tv_level,mtvcomplete;
    private ImageView mLeftView;
    private JiuyiButton mbtnsave;
    private JiuyiEditText et_specialprice;
    ...
    @Override
    public void onInit() {
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_addproduct_layout"), null);
        ...
        if(mbtnsave!=null){
            mbtnsave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    newSpecialProductBean.setSpecialPrice(Double.parseDouble(et_specialprice.getText().toString().toString()));
            ...
            public void onClick(View v) {
                if (FastUtils.isFastClick()) {
                    ...
                    if(priceBeanList!=null &&priceBeanList.size()>0){
                        AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiAddProductActivity.this);
        ...
        et_specialprice= (JiuyiEditText) mBodyLayout.findViewById(Res.getViewID(null, "et_specialprice"));
        if(newSpecialProductBean!=null){
            ...
            if(newSpecialProductBean.getSpecialPrice()!=null){
                et_specialprice.setText(newSpecialProductBean.getSpecialPrice()+"");
            }
        }
    }
    ...
    public void setBackActivityBundle() {
        ...
        JiuyiAddProductActivity.this.setResult(1, intent);
    }
    ...
    public boolean check(){
        ...
        if(TextUtils.isEmpty(et_specialprice.getText().toString().trim())){
            startDialog(DialogID.DialogDoNothing, "", "请输入特价！", JiuyiDialogBase.Dialog_Type_Yes, null);
            return false;
        }
