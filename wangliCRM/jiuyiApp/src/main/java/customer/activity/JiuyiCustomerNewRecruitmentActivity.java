...
/**
 * ****************************************************************
 * 文件名称 : JiuyiCustomerNewRecruitmentActivity
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 工厂招工新增页面
 *****************************************************************
 */
public class JiuyiCustomerNewRecruitmentActivity extends JiuyiNewIncludeAttachActivity {
    ...
    private RecruitmentBean.ContentBean updateBean;
    private RecruitmentBean.ContentBean productinfoBean;
    ...
    public void onInit() {
        ...
        super.onInit();
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_customernewrecruitment_layout"), null);
                                            ...
                                            if(attachmentsBeanslist.size()==Bimp.tempSelectBitmap.size()){
                                                if(viewOperatorType.equals(ViewOperatorType.EDIT)){
                                                    ...
                                                    if(productinfoBean==null){
                                                        productinfoBean=new RecruitmentBean.ContentBean();
                                                    }
    ...
    public void initViews(){
        ...
        tvType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiCustomerNewRecruitmentActivity.this);
        ...
        if (tvDate != null) {
            tvDate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DatePickDialog dialog = new DatePickDialog(JiuyiCustomerNewRecruitmentActivity.this);
                    //设置上下年分限制
    ...
    public void submit(){
        JiuyiHttp.POST("recruitment/create")
//                .baseUrl("http://192.168.123.50:9090/api/")
   ...
   private void getProductinfoList(long id) {
    JiuyiHttp.GET("recruitment/detail/"+id)
            .tag("request_get_recruitment")
            .addHeader("Authorization", Rc.id_tokenparam)
            .request(new ACallback<RecruitmentBean.ContentBean>() {
                @Override
                public void onSuccess(RecruitmentBean.ContentBean contentBean) {
                    if(contentBean!=null){
    ...
    public void updateProductInfo(){
        if(updateBean==null){
            updateBean =new RecruitmentBean.ContentBean();;
        ...
        JiuyiHttp.PUT("recruitment/update")
