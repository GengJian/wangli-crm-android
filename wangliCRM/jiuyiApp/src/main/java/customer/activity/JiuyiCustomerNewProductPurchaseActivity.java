...
/**
 * ****************************************************************
 * 文件名称 : JiuyiCustomerNewProductPurchaseActivity
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 采购招标新增页面
 *****************************************************************
 */
public class JiuyiCustomerNewProductPurchaseActivity extends JiuyiNewIncludeAttachActivity {
    ...
    private ProductpurchaseBean.ContentBean updateBean;
    private ProductpurchaseBean.ContentBean productinfoBean;
    ...
    public void onInit() {
        ...
        super.onInit();
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_customernewproductpurchase_layout"), null);
                                            ...
                                            if(attachmentsBeanslist.size()==Bimp.tempSelectBitmap.size()){
                                                if(viewOperatorType.equals(ViewOperatorType.EDIT)){
                                                    ...
                                                    if(productinfoBean==null){
                                                        productinfoBean=new ProductpurchaseBean.ContentBean();
                                                    }
    ...
    public void initViews(){
        ...
        tvType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiCustomerNewProductPurchaseActivity.this);
        ...
        if (tvDate != null) {
            tvDate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DatePickDialog dialog = new DatePickDialog(JiuyiCustomerNewProductPurchaseActivity.this);
                    //设置上下年分限制
    ...
    public void submit(){
        JiuyiHttp.POST("purchase_tender/create")
   ...
   private void getProductinfoList(long id) {
    JiuyiHttp.GET("purchase_tender/detail/"+id)
            .tag("request_get_purchase_tender")
            .addHeader("Authorization", Rc.id_tokenparam)
            .request(new ACallback<ProductpurchaseBean.ContentBean>() {
                @Override
                public void onSuccess(ProductpurchaseBean.ContentBean contentBean) {
                    if(contentBean!=null){
    ...
    public void updateProductInfo(){
        if(updateBean==null){
            updateBean =new ProductpurchaseBean.ContentBean();;
        ...
        JiuyiHttp.PUT("purchase_tender/update")
