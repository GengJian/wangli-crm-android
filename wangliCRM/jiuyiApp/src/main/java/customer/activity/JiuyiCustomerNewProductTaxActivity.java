...
/**
 * ****************************************************************
 * 文件名称 : JiuyiCustomerNewProductTaxActivity
 * 作       者 : zhengss
...
public class JiuyiCustomerNewProductTaxActivity extends JiuyiNewIncludeAttachActivity {
    ...
    private ProducttaxBean.ContentBean updateBean;
    private ProducttaxBean.ContentBean productinfoBean;
                                            ...
                                            if(attachmentsBeanslist.size()==Bimp.tempSelectBitmap.size()){
                                                if(viewOperatorType.equals(ViewOperatorType.EDIT)){
                                                    ...
                                                    if(productinfoBean==null){
                                                        productinfoBean=new ProducttaxBean.ContentBean();
                                                    }
    ...
    public void initViews(){
        ...
        tvType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiCustomerNewProductTaxActivity.this);
        ...
        if (tvDate != null) {
            tvDate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DatePickDialog dialog = new DatePickDialog(JiuyiCustomerNewProductTaxActivity.this);
                    //设置上下年分限制
    ...
    public void submit(){
        JiuyiHttp.POST("tax_rating/create")
   ...
   private void getProductinfoList(long id) {
    JiuyiHttp.GET("tax_rating/detail/"+id)
            .tag("request_get_spot_check")
            .addHeader("Authorization", Rc.id_tokenparam)
            .request(new ACallback<ProducttaxBean.ContentBean>() {
                @Override
                public void onSuccess(ProducttaxBean.ContentBean contentBean) {
                    if(contentBean!=null){
    ...
    public void updateProductInfo(){
        if(updateBean==null){
            updateBean =new ProducttaxBean.ContentBean();;
        ...
        JiuyiHttp.PUT("tax_rating/update")
