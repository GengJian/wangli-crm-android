...
/**
 * ****************************************************************
 * 文件名称 : JiuyiCustomerNewProductLicenseActivity
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 生产许可新增页面
 *****************************************************************
 */
public class JiuyiCustomerNewProductLicenseActivity extends JiuyiNewIncludeAttachActivity {
    ...
    private ProductlicenseBean.ContentBean updateBean;
    private ProductlicenseBean.ContentBean productinfoBean;
    ...
    public void onInit() {
        ...
        super.onInit();
        mBodyLayout = (JiuyiRelativeLayout) LayoutInflater.from(this).inflate(Res.getLayoutID(this, "jiuyi_activity_customernewproductlicense_layout"), null);
                                            ...
                                            if(attachmentsBeanslist.size()==Bimp.tempSelectBitmap.size()){
                                                if(viewOperatorType.equals(ViewOperatorType.EDIT)){
                                                    ...
                                                    if(productinfoBean==null){
                                                        productinfoBean=new ProductlicenseBean.ContentBean();
                                                    }
    ...
    public void initViews(){
        ...
        tvType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder buidler = new AlertDialog.Builder(JiuyiCustomerNewProductLicenseActivity.this);
        ...
        if (tvDate != null) {
            tvDate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    DatePickDialog dialog = new DatePickDialog(JiuyiCustomerNewProductLicenseActivity.this);
                    //设置上下年分限制
    ...
    public void submit(){
        JiuyiHttp.POST("production_license/create")
   ...
   private void getProductinfoList(long id) {
    JiuyiHttp.GET("production_license/detail/"+id)
            .tag("request_get_spot_check")
            .addHeader("Authorization", Rc.id_tokenparam)
            .request(new ACallback<ProductlicenseBean.ContentBean>() {
                @Override
                public void onSuccess(ProductlicenseBean.ContentBean contentBean) {
                    if(contentBean!=null){
    ...
    public void updateProductInfo(){
        if(updateBean==null){
            updateBean =new ProductlicenseBean.ContentBean();;
        ...
        JiuyiHttp.PUT("production_license/update")
