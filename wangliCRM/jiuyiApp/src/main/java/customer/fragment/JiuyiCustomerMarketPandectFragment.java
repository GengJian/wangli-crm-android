...
/**
 * ****************************************************************
 * 文件名称 : JiuyiCustomerMarketPandectFragment
 * 作       者 : zhengss
 * 创建时间:2018/7/03 14:43
 * 文件描述 : 客户市场动态信息总览
 *****************************************************************
 */
public class JiuyiCustomerMarketPandectFragment extends JiuyiFragmentBase {
        ...
        if(mibadd!=null){
            mibadd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mBundle.putInt(JiuyiBundleKey.PARAM_PAGETYPE,Pub.Customer_newmarketdynamic);
                    ...
                    Rc.getIns().getBaseCallTopCallBack().changePage(mBundle, Pub.Customer_newmarketdynamic,true);
                }
            });
        }
    }
    ...
    private void getRiskWarnList() {
        Thread thread = new Thread()
        {
            ...
            public void run() {
                super.run();
                JiuyiHttp.GET("market-trend/statistics/"+Customerid+"?fromClientType=android")
                                ...
                                if(data.getContent()!=null &&data.getContent().size()>0){
                                    ...
                                    riskWarnAdapter.setOnRecyclerViewItemListener(new RiskWarnAdapter.OnRecyclerViewItemListener(){
                                        ...
                                        public void onItemClickListener(View view, int position) {
                                            ...
                                            mBundle.putInt(JiuyiBundleKey.PARAM_TRADEPAGETYPE,Pub.Customer_Contract);
                                            ...
                                            Rc.getIns().getBaseCallTopCallBack().changePage(mBundle, Pub.Customer_Contract,false);
                                        }
     ...
     * 然后返回新的fragment到调用者
     */
    public static JiuyiCustomerMarketPandectFragment newInstance(int nPageType) {
        JiuyiCustomerMarketPandectFragment f = new JiuyiCustomerMarketPandectFragment();
     ...
     * 然后返回新的fragment到调用者
     */
    public static JiuyiCustomerMarketPandectFragment newInstance(int nPageType, Bundle mBundle) {
        JiuyiCustomerMarketPandectFragment f = new JiuyiCustomerMarketPandectFragment();
        Bundle args;
        if(mBundle != null){
