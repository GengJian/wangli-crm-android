 ...
 *
 */
public class NewPlanOrderAdapter extends SwipeMenuAdapter<NewPlanOrderAdapter.DefaultViewHolder> {
    ...
    public NewPlanOrderAdapter(List<NewSpecialProductBean> viewTypeBeanList) {
    ...
    @Override
    public NewPlanOrderAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
        return new DefaultViewHolder(realContentView);
    }

    @Override
    public void onBindViewHolder(NewPlanOrderAdapter.DefaultViewHolder holder, int position) {
    ...
    static class DefaultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(NewSpecialProductBean viewTypeBean) {
            ...
            if(viewTypeBean.getCount()!=null){
                this.tv_speialprice.setText("数量: "+viewTypeBean.getCount());
            }
