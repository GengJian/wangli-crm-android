...
public class InfomationPictureAdapter extends BaseAdapter {
    ...
    public InfomationPictureAdapter(JiuyiMainApplication ins, List<ImageBean> attachList) {
    ...
    public InfomationPictureAdapter(Activity context, ItemClickListener itemClickListener, List<ImageBean> beansList) {
    ...
    public InfomationPictureAdapter(Activity context, ItemClickListener itemClickListener) {
        this.context = context;
        this.itemClickListener = itemClickListener;
        inflater = LayoutInflater.from(context);
    }
