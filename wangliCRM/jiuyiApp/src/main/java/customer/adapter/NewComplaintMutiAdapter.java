 ...
 *
 */
public class NewComplaintMutiAdapter extends SwipeMenuAdapter<NewComplaintMutiAdapter.DefaultViewHolder> {
    ...
    public NewComplaintMutiAdapter(List<BatchTransBean> viewTypeBeanList) {
    ...
    public View onCreateContentView(ViewGroup parent, int viewType) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.jiuyi_newcomplaintmulti_item, parent, false);
    }

    @Override
    public NewComplaintMutiAdapter.DefaultViewHolder onCompatCreateViewHolder(View realContentView, int viewType) {
        return new DefaultViewHolder(realContentView);
    }

    @Override
    public void onBindViewHolder(NewComplaintMutiAdapter.DefaultViewHolder holder, int position) {
