...
public class PurchaseItemAdapter extends RecyclerView.Adapter<PurchaseItemAdapter.ViewHolder> {
    ...
    public PurchaseItemAdapter(Context mContext, String[] data, String[] imgdata) {
    ...
    public PurchaseItemAdapter(Context mContext, String[] data, String[] imgdata, String[] countdata) {
        this.mContext = mContext;
        this.data = data;
    ...
    public PurchaseItemAdapter(Context mContext, List<RiskWarnBean.ContentBean> contentBeanlist) {
        this.mContext = mContext;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = inf.inflate(R.layout.customer_purchase_item, viewGroup, false);
