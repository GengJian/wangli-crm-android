...
public class TotalPlanRoundlProgresWithNum extends CustomHorizontalProgresNoNum{
    ...
    public TotalPlanRoundlProgresWithNum(Context context) {
        this(context,null);
    }

    public TotalPlanRoundlProgresWithNum(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public TotalPlanRoundlProgresWithNum(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (mCustomHasNum){
            ...
            String currentProgress = getProgress()*10/36+"%";
