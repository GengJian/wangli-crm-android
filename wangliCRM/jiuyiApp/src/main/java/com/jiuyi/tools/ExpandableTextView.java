...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        tv_expandable_content = (TextView) findViewById(R.id.tv_expandable_content);
        tv_expand_or_collapse = (TextView) findViewById(R.id.tv_expand_or_collapse);
...
//            L.i("================================lineCount:" + lineCount + "======================================");
            if (lineCount > MAX_COLLAPSED_LINES) {
                ...
                tv_expand_or_collapse.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.c_down_s, 0, 0);
            ...
            switch (state) {
                ...
                case STATE_COLLAPSED:
                    tv_expandable_content.setMaxLines(MAX_COLLAPSED_LINES);
                    tv_expand_or_collapse.setVisibility(View.VISIBLE);
                    tv_expand_or_collapse.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.drop_down_s, 0, 0);
                    break;
                case STATE_EXPANDED:
                    tv_expandable_content.setMaxLines(Integer.MAX_VALUE);
                    tv_expand_or_collapse.setVisibility(View.VISIBLE);
                    tv_expand_or_collapse.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.c_down_s, 0, 0);
                    break;
            }
            tv_expandable_content.setText(text);
        }
    ...
    public void onClick(View v) {
        ...
        if (state == STATE_COLLAPSED) {
            tv_expand_or_collapse.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.drop_down_s, 0, 0);
            tv_expandable_content.setMaxLines(Integer.MAX_VALUE);
