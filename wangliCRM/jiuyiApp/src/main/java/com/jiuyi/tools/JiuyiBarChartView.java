 ...
 */
public class JiuyiBarChartView extends baseChartView{
	...
	public JiuyiBarChartView(Context context) {
		super(context);
	...
	public JiuyiBarChartView(Context context, AttributeSet attrs){
		super(context, attrs);
		initView();
	}

	public JiuyiBarChartView(Context context, AttributeSet attrs, int defStyle) {
