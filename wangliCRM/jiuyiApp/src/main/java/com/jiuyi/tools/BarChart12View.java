...
import com.control.widget.xclcharts.chart.BarChart;
...
import static com.control.widget.xclcharts.renderer.XEnum.HorizontalAlign.LEFT;
 ...
 */
public class BarChart12View extends baseChartView{
	...
	public List<BarData> getChartData2() {
		return chartData2;
	}

	public void setChartData2(List<BarData> chartData2) {
...
//		chartDataSet2();
	...
	{
		int [] ltrb = new int[4];
		ltrb[0] = DensityUtil.dip2px(getContext(), -170); //left
		ltrb[1] = DensityUtil.dip2px(getContext(), 60); //top
		ltrb[2] = DensityUtil.dip2px(getContext(), 30); //right
		ltrb[3] = DensityUtil.dip2px(getContext(), 35); //bottom
		return ltrb;
	}
...
//		dataSeriesA.add(100d);
		...
		dataColorA.add(Res.getColor(null, "jiuyi_dividebackgroud_color"));
		dataColorA.add(Res.getColor(null, "jiuyi_dividebackgroud_color"));
//		dataColorA.add(Res.getColor(null, "jiuyi_dividebackgroud_color"));
//		dataColorA.add(Res.getColor(null, "jiuyi_dividebackgroud_color"));
...
//		chartLabels.add("");
	...
	public void chartRender2(String title)
	{
		try {
...
//		dataSeriesA.add(95d);
		...
		//依数据值确定对应的柱形颜色.
		List<Integer> dataColorA= new LinkedList<Integer>();
		dataColorA.add(Color.rgb(221, 189, 69));
		dataColorA.add(Color.rgb(126, 164, 255));
//		dataColorA.add(Color.rgb(145, 204, 93));
//		dataColorA.add(Color.rgb(207, 123, 114));
