...
public class OrderSearchUtils {
    ...
    private static OrderSearchUtils single = null;
    ...
    private final String KEY = "order_search_history";

    // 静态工厂方法
    public static OrderSearchUtils getInstance() {
        if (single == null) {
            single = new OrderSearchUtils();
        }
        return single;
    }
