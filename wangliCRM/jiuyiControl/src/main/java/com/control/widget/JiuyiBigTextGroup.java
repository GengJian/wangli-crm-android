...
public class JiuyiBigTextGroup extends FrameLayout implements View.OnClickListener {
...
//    private LinearLayout itemGroupLayout; //组合控件的布局
    ...
    public JiuyiBigTextGroup(@NonNull Context context) {
        super(context);
        initView(context);
    }

    public JiuyiBigTextGroup(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        initAttrs(context, attrs);
    }

    public JiuyiBigTextGroup(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.jiuyi_item_bigtext_layout, null);
