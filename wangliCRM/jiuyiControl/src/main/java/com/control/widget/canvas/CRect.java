...
public class CRect // extends CRectangle
{
	...
	public int nAction = 0;// 本CRect的功能
	...
	public CRect(int left_, int top_, int right_, int bottom_) {
		left = left_;
		right = right_;
		top = top_;
		bottom = bottom_;
	...
	public CRect(int left_, int top_, int right_, int bottom_, int action) {
		this(left_, top_, right_, bottom_);
		nAction = action;
	}

	public CRect(int left_, int top_, int right_, int bottom_, int xPos, int yPos) {
		this(left_, top_, right_, bottom_);
		this.xPos = xPos;
		this.yPos = yPos;
	}
	...
	public void SetRect(CRect rect) {
		if (rect == null)
			return;
	...
	public static boolean IsRectEmpty(CRect rect) {
