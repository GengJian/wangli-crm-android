...
public class LazyViewPager extends ViewPager {
	...
	public LazyViewPager(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, Res.getStyleableArray(getContext(), "LazyViewPager"));
		
		setInitLazyItemOffset(a.getFloat(Res.getStyleableID(getContext(), "LazyViewPager_init_lazy_item_offset"), DEFAULT_OFFSET));
		a.recycle();
	}
