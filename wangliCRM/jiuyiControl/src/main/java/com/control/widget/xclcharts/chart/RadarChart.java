 ...
 */
package com.control.widget.xclcharts.chart;

import java.util.List;

import com.control.utils.Res;
import com.control.widget.xclcharts.common.DrawHelper;
import com.control.widget.xclcharts.common.MathHelper;
import com.control.widget.xclcharts.renderer.RdChart;
import com.control.widget.xclcharts.renderer.XEnum;
import com.control.widget.xclcharts.renderer.axis.CategoryAxis;
import com.control.widget.xclcharts.renderer.axis.CategoryAxisRender;
import com.control.widget.xclcharts.renderer.axis.DataAxis;
import com.control.widget.xclcharts.renderer.axis.DataAxisRender;
import com.control.widget.xclcharts.renderer.line.PlotDot;
import com.control.widget.xclcharts.renderer.line.PlotDotRender;
import com.control.widget.xclcharts.renderer.line.PlotLine;
...
public class RadarChart extends RdChart {
    ...
    protected Paint mPaintLabelValue = null;
     ...
     * @return 画笔
     */
    public Paint getLabelValuePaint()
    {
        if(null == mPaintLabelValue)
        {
            mPaintLabelValue = new Paint();
            mPaintLabelValue.setColor(Color.parseColor("#FF4290F7"));
            mPaintLabelValue.setTextSize(32);
            mPaintLabelValue.setAntiAlias(true);
            mPaintLabelValue.setTextAlign(Align.CENTER);
        }
        return mPaintLabelValue;
    }
