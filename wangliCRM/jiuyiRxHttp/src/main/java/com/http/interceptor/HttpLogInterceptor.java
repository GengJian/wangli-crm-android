...
public class HttpLogInterceptor implements Interceptor {
    ...
    private void log(String message) {
        ...
        if (message.startsWith("<-- END HTTP")) {
            HttpLog.i(showMessage.toString());
        }
        ...
        try {
            ...
            if (requestBody != null) {
                ...
                if (charset != null) {
                    ...
                    try {
                        String  requst = java.net.URLDecoder.decode(buffer.readString(charset).replaceAll("%", "%25"),"UTF-8");
//                        requst = java.net.URLDecoder.decode(requst.replaceAll("%", "%25") ,"UTF-8");
                        log("\tbody:" + requst);
