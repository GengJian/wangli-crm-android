...
import com.http.body.UploadProgressRequestBody;
...
//    public UploadRequest addFiles2(Map<String, File> fileMap) {
//        if (fileMap == null) {
//            return this;
//        }
//        for (Map.Entry<String, File> entry : fileMap.entrySet()) {
//            addFile("file", entry.getValue());
//        }
//        return this;
//    }
    public UploadRequest addFiles2(String key,File[] files) {
