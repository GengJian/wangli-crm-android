...
import com.http.mode.DownProgress;
import com.http.subscriber.DownCallbackSubscriber;
...
public class DownloadRequest extends BaseHttpRequest<DownloadRequest> {
    ...
    private String dirName = jiuyiConfig.DEFAULT_DOWNLOAD_DIR;
    private String fileName = jiuyiConfig.DEFAULT_DOWNLOAD_FILE_NAME;

    public DownloadRequest(String suffixUrl) {
        super(suffixUrl);
        rootName = getDiskCachePath(JiuyiHttp.getContext());
    }
