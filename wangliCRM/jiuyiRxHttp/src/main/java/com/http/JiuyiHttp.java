...
import com.http.request.BaseHttpRequest;
import com.http.request.DeleteRequest;
import com.http.request.DownloadRequest;
import com.http.request.GetRequest;
import com.http.request.HeadRequest;
import com.http.request.OptionsRequest;
import com.http.request.PatchRequest;
import com.http.request.PostRequest;
import com.http.request.PutRequest;
import com.http.request.RetrofitRequest;
import com.http.request.UploadRequest;
...
public class JiuyiHttp {
    ...
    public static Context getContext() {
        if (context == null) {
            throw new IllegalStateException("Please call JiuyiHttp.init(this) in Application to initialize!");
        }
        return context;
    }
