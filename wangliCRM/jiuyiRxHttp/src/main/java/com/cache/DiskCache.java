...
public class DiskCache implements ICache {
    ...
    private long cacheTime = jiuyiConfig.CACHE_NEVER_EXPIRE;

    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, jiuyiConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, jiuyiConfig.CACHE_DISK_DIR)));
    }
            ...
            if (snapshot != null) {
                ...
                if (!TextUtils.isEmpty(content)) {
                    ...
                    if ((createTime + expireMills > Calendar.getInstance().getTimeInMillis())
                            || expireMills == jiuyiConfig.CACHE_NEVER_EXPIRE) {
